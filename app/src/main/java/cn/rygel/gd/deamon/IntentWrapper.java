            ...
            switch (iw.type) {
                case DOZE:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        new MaterialDialog.Builder(a)
                                ...
                                .content(reason + "需要 " + getApplicationName() + " 加入到电池优化的忽略名单。\n\n" +
                ...
                case HUAWEI:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要允许 " + getApplicationName() + " 的自动启动。\n\n" +
                ...
                case HUAWEI_GOD:
                    new MaterialDialog.Builder(a)
                            .title(getApplicationName() + " 需要加入锁屏清理白名单")
                            .content(reason + "需要 " + getApplicationName() + " 加入到锁屏清理白名单。\n\n" +
                ...
                case XIAOMI_GOD:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要关闭 " + getApplicationName() + " 的神隐模式。\n\n" +
                ...
                case SAMSUNG_L:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要 " + getApplicationName() + " 在屏幕关闭时继续运行。\n\n" +
                ...
                case MEIZU:
                    new MaterialDialog.Builder(a)
                            .title("需要允许 " + getApplicationName() + " 保持后台运行")
                            .content(reason + "需要允许 " + getApplicationName() + " 保持后台运行。\n\n" +
                ...
                case MEIZU_GOD:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要 " + getApplicationName() + " 在待机时保持运行。\n\n" +
                ...
                case OPPO_OLD:
                    new MaterialDialog.Builder(a)
                            .title("需要允许 " + getApplicationName() + " 的自启动")
                            .content(reason + "需要 " + getApplicationName() + " 加入到自启动白名单。\n\n" +
                ...
                case COOLPAD:
                    new MaterialDialog.Builder(a)
                            .title("需要允许 " + getApplicationName() + " 的自启动")
                            .content(reason + "需要允许 " + getApplicationName() + " 的自启动。\n\n" +
                ...
                case VIVO_GOD:
                    new MaterialDialog.Builder(a)
                            .title("需要允许 " + getApplicationName() + " 的后台运行")
                            .content(reason + "需要允许 " + getApplicationName() + " 在后台高耗电时运行。\n\n" +
                ...
                case GIONEE:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要允许 " + getApplicationName() + " 的自启动和后台运行。\n\n" +
                ...
                case LETV_GOD:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要禁止 " + getApplicationName() + " 被自动清理。\n\n" +
                ...
                case LENOVO:
                    new MaterialDialog.Builder(a)
                            .title("需要允许 " + getApplicationName() + " 的后台运行")
                            .content(reason + "需要允许 " + getApplicationName() + " 的后台自启、后台 GPS 和后台运行。\n\n" +
                ...
                case LENOVO_GOD:
                    new MaterialDialog.Builder(a)
                            ...
                            .content(reason + "需要关闭 " + getApplicationName() + " 的后台耗电优化。\n\n" +
