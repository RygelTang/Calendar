package cn.mt.gd.bean.event.constants;
...
import cn.mt.gd.R;
import cn.mt.gd.app.APP;
import mt.cn.uilibrary.utils.UIUtils;

import static cn.mt.gd.bean.event.constants.RepeatType.EVERY_YEAR;
import static cn.mt.gd.bean.event.constants.RepeatType.NO_REPEAT;
